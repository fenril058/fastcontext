...
- Results are capped to 100 output lines for responsiveness; when truncation occurs the output ends with a "Results truncated" line. Narrow the pattern, path, or glob rather than expecting more lines.
